/*
 * Fastboot.cs - Developed by Mrivai for XiaomiLib.dll
 */
...
namespace Mrivai.Pelitabangsa
{
    ...
    public class FastbootCommand
    {
        ...
        internal FastbootCommand(string command) { Command = command; Timeout = Mrivai.Command.DEFAULT_TIMEOUT; }
        
        /// <summary>
        /// Sets the timeout for the FastbootCommand
        /// </summary>
        /// <param name="timeout">The timeout for the command in milliseconds</param>
        public FastbootCommand WithTimeout(int timeout) { Timeout = timeout; return this; }
    }
    ...
    public static class Fastboot
    {
		...
		private const string EDL_EXE = "edl.exe";

        /// <summary>
        /// Executes a Fastboot device Command, for checking connected android device
        /// </summary>
        ...
        /// <summary>
        /// Executes a Fastboot oem device-info Command
        /// </summary>
        internal static string info()
        {
            return ExecuteFastbootCommand(FormFastbootCommand("oem device-info"));
        }

        /// <summary>
        /// Executes a Fastboot getvar anti Command, for checking xiaomi Anti Roll Back system
        /// </summary>
        internal static string ARB()
        {
            return ExecuteFastbootCommand(FormFastbootCommand("getvar anti"));
        }

        /// <summary>
        /// Executes a Fastboot reboot-edl Command, for reboot device into edl mode
        /// </summary>
        internal static void EDL()
        {
            Command.RunProcessNoReturn(AndroidController.Instance.ResourceDirectory + EDL_EXE, "reboot-edl", -1);
        }
        /// <summary>
        /// Executes a Fastboot oem edl Command, for reboot device into edl mode
        /// </summary>
        internal static void OemEDL()
        {
            Command.RunProcessNoReturn(AndroidController.Instance.ResourceDirectory + EDL_EXE, "oem edl", -1);
        }
